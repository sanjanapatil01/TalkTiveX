    ...
    <div className={`bg-[#818582]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden":''}`}>
        <div className='pb-5'>
                ...
                <div className="relative py-2 group">
                   <img src={assets.menu_icon} alt="Menu" className='max-h-5 cursor-pointer' />
                     <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block'>
                        ...
                        <hr className='my-2 border-t border-gra-500'/>
            ...
            <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
                ...
                <input type="text" onChange={(e)=>setInput(e.target.value)}  className='bg-transperant border-none outline-none text-white text-xs placeholder-[#c8c8c8] flex-1' placeholder='Search User' />
            </div>
            ...
            <div className="flex flex-col">
                 ...
                 >
                     ...
                     />
                        <div className="flex flex-col heading-5">
                            <p>{user.fullName}</p>
